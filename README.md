...
📎 **[打开我们的绘图素材库 ↗](https://1drv.ms/p/c/bd7539b4ad7affa6/IQBPrC-ypuGiQr7ztoId3BOCAQiWo0fmrUZCAro9emryfV8?e=Z4KcdQ)** · 在线共编 · 可下载 PPTX

我把自己攒的参考 PPT 开放出来了，先抛砖引玉～**大家都可以编辑**，有更好看的图、配色、布局或小组件，欢迎直接添进去，让这本素材库越攒越好看。如果你在里面认出了自己的图——老师好，拜师申请先递上了 🙇

拿去参考，也欢迎往里添。补充时顺手留个作者和来源链接，已有素材尽量保留；下载到本地后，把路径交给 Astra 就能用。

想讨论绘图、交流研究，也欢迎加我联系方式来聊～我主要关注 **图像 / 视频生成与世界模型**，有兴趣可以一起做些有意思的工作。联系方式在 <a href="https://jerrysnow.me"><img src="docs/media/brand/homepage-inline.svg" alt="jerrysnow.me · 联系方式" height="24" align="absmiddle"></a>。
...
共享 PPT 是一起积累的绘图参考，不代表其中所有素材都能任意转载或商用；原图权利归原作者，使用时请核对来源与授权。补充素材前，也请确认可以分享，不要放入未公开论文或他人的私人材料。仓库本身只放获准展示的案例，目前尚未指定整体开源许可证，第三方素材仍按各自条款使用。[首页插画与字体说明](docs/media/brand/README.md)。
